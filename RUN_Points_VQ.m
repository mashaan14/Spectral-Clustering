function RUN_Points_VQ(X, k, method, NumOfNeurons, FlagPlot, AffMatMethod)
...
%             net.trainFcn = 'Mytrainbu';
    ...
    [NumOfRowNeurons,NumOfColNeurons] = size(NeuronsWeights);
    clearvars -except X ia ic k LabelsInitial AffMatMethod SigmaLocal NumOfNeurons NumOfRow NumOfCol FlagPlot FlagPlotResult MaxK NumOfRowNeurons NumOfColNeurons NeuronsWeights NeuronsDistances NormalizeCoeff1
    %% =======================================================
    ...
    [~,D,vN] = svds(LapN,min(NumOfNeurons,1000),'smallest');
